...
def create_sections(filename, page_map):
    ...
    category = args.category or "GeneralInfo"
    if "Boots" in filename or "Shoes" in filename:
        category = "Footwear"
    if "Shorts" in filename:
        category = "Shorts"
    if "Pants" in filename:
        category = "Pants"
    if "Jacket" in filename:
        category = "Jacket"
    if "Shirts" in filename:
        category = "Shirts"
    if "environmental" in filename:
        category = "EnvironmentPolicies"
    if "return" in filename:
        category = "ReturnPolicies"
